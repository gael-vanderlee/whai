...
[2025-11-02] [test] [tests]: remove implementation detail tests; delete 36 tests of private functions to align with behavioral testing philosophy; remove tests of _is_wsl, _get_tmux_context, _parse_*_history, _matches_command_pattern, _validate_model, _get_litellm_model_name, _extract_inline_overrides, _get_set_command, _get_clear_command, _handle_streaming_response; delete test_inline_parsing.py and test_llm_streaming.py entirely; all behaviors still covered through public API and integration tests; test suite reduced by 24% while maintaining full coverage
